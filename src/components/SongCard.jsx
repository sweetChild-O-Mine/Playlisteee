...
export const SongCard = ({index, songName, artistName, albumArt }) => {
  return (

    // main container div
        <div className="group border-b border-neutral-400 hover:border-neutral-400/50 hover:scale-102 transition-all duration-200 py-2 min-w-lg flex justify-between px-4 items-center ease-in-out cursor-pointer ">
            {/* div one  */}
